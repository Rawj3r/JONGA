...
public class GCMRegistrationIntentService extends IntentService{
    ...
    private void saveTokenToServer(String token){
        ...
        paramPost.put("type","tokenID");
        paramPost.put("tokenID", token);
        paramPost.put("username", "null");
        paramPost.put("phonenumber", "null");
        paramPost.put("ownerDeviceID", "null");
        paramPost.put("unitStatus", "null");
        paramPost.put("contactID", "null");
        paramPost.put("contactPhoneNumber", "null");
        paramPost.put("contactDeviceID", "null");
        paramPost.put("password", "null");
        paramPost.put("notificationType", "null");
        paramPost.put("message", "null");

        try {
            String msgResult = getStringResultFromServicePOST("http://jonga.co/jongas/", paramPost);
    ...
    public String getStringResultFromServicePOST(String serviceURL, Map<String, String> params){
